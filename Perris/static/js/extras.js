function runValidator()
{
    ...
    var runValidator = document.getElementById("runValidator")
    ...
    if(txtRun.value.trim().length < 9)
    {
      runValidator.innerHTML = "Debe tener un largo de 9"
    }
    else
    {
      runValidator.innerHTML = ""
    }
}
